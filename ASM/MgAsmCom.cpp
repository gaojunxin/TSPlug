...
//
char	*	g_szSegName[8] = { "ES","CS","SS","DS","FS","GS","SEG?","SEG?" };


//
char	*	g_szCRName[9] = { "CR0","CR1","CR2","CR3","CR4","CR5","CR6","CR7","CRX" };

//
char	*	g_szDRName[9] = { "DR0","DR1","DR2","DR3","DR4","DR5","DR6","DR7","DRX" };

//
char	*	g_szFPUName[9] = { "ST0","ST1","ST2","ST3","ST4","ST5","ST6","ST7","FPU" };

//
char	*	g_szMMXName[9] = { "MM0","MM1","MM2","MM3","MM4","MM5","MM6","MM7","MMX" };


//
char	*	g_szSizeName[11] = 
{	
